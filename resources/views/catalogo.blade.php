...
<div class="container"> <div class="row"> <div class="col-md-12">
    ...
    Ver Carrito
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0
    16 16">
...
<div class="container"> <div class="row"> @foreach($productos as $producto) <!-- Producto --> <div class="col-md-4">
    <div class="card mb-4">
    <div class="card-body">
    <h5 class="card-title">Nombre: {{ $producto->nombre }}</h5>
    <h5 class="card-title" hidden>Id: {{ $producto->id }}</h5>
    ...
    <input type="number" id="stock{{ $producto->id }}" disabled value="{{ $producto->stock }}" hidden>
...
<script>
    ...
    function agregarAlCarrito(id) {
        ...
        if (cantidad > 0 && cantidad <= cantidadPedido) {
            ...
            if (productoEnCarrito) {
                ...
                var nombre = "Producto"; // Reemplaza esto con el nombre real del producto
                var precio = 0; // Reemplaza esto con el precio real del producto
    ...
    function verCarrito() {
        // Aquí puedes redirigir al usuario a la página del carrito o realizar alguna otra acción.
        // Puedes acceder al carrito en el localStorage para mostrar los productos seleccionados.
        // Por ejemplo: window.location.href = '/carrito';
    }
