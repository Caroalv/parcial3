...
<div class="container"> <h1 class="text-center">Checkout de Compra</h1> <div class="row justify-content-center">
    <div class="col-md-8">
    ...
    </div> <style> /* Estilo para el botón sin fondo */ .eliminar-button { background: none; border: none; color: blue;
        /* Color del texto */ text-decoration: underline; /* Agregar subrayado al texto */ cursor: pointer; } </style>
    <script>
        ...
        function mostrarProductosDelCarrito() {
            if (carrito.length === 0) {
                ...
                carrito.forEach(function (producto, index) {
                    carritoHTML += '<button class="eliminar-button" onclick="eliminarProducto(' + index + ')">Eliminar de la lista</button>';
                    carritoHTML += '<li class="list-group-item d-flex justify-content-between align-items-center lh-sm"><div><h4 class="my-0">' + producto.nombre + '</h4><small class="text-body-secondary"><h5 class="my-0">Cantidad: ' + producto.cantidad + '</h5></small></div><span class="text-body-secondary"><h5 class="my-0">$' + (producto.precio * producto.cantidad) + '</h5></span>';
                    carritoHTML += '</li>';
                    carritoHTML += '<hr>';
                });
                ...
                carritoHTML += '<li class="list-group-item d-flex justify-content-between"><span><h4 class="my-0">Total (USD)</h4></span><strong><h4 class="my-0">$' + totalVenta + '</h4></strong></li>';
